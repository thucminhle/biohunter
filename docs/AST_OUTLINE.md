...
KANBAN_COLUMNS = [('new', 'New'), ('scored', 'Scored'), ('prepared', 'Prepared'), ('applied', 'Applied'), ('rejected', 'Rejected'), ('stale', 'Stale')]
...
_HUMANIZE_SECTIONS: tuple[tuple[str, str], ...] = (('tailored_summary', 'Tailored Summary'), ('tailored_bullets', 'Tailored Bullets'), ('cover_letter', 'Cover Letter'))
...
_TOKEN_RUN_KIND_LABELS = {'generate': 'Generate', 'batch_generate': 'Batch generate', 'score_batch': 'Score batch'}
...
def _token_cost_calculator_html(pricing: dict, pricing_updated: str | None, default_prompt: int, default_completion: int) -> str:
...
## `src/biohunter/dashboard_settings.py`
```python
...
def save_final_edit(conn, posting_id: int, tailored_summary: str, tailored_bullets: str, cover_letter: str) -> None:
...
def humanize_section(text: str, section_key: str, job_description: str, llm: LLMClient, role: str='writer_humanizer', timeout: int=600) -> str:
